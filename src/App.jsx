...
import { DEFAULT_CHAR_STICKERS } from "./constants/stickers";
import { DEFAULT_USER_STICKERS } from "./constants/stickers";
...
const isImageMsg = (content) =>
  content && content.startsWith(IMG_TAG_START) && content.endsWith(IMG_TAG_END);

const getImageDesc = (content) =>
  content.replace(IMG_TAG_START, "").replace(IMG_TAG_END, "");
                          ...
                          {editIndex === i ? (
                            ...
                            >
                              ...
                              {(() => {
                                ...
                                // C. 假图片逻辑
                                const isFakeImg = isImageMsg(msg.text); // 【改】：不要手动写 startsWith("<fake_image>")，直接用函数

                                if (isFakeImg) {
                                  const imgDesc = getImageDesc(msg.text); // 【改】：不要手动写两个 .replace()，直接用函数
