...
export const MinimalCard = ({ item, type = "fact", onDelete, onEdit }) => {
  ...
  const baseClasses = `
    ...
    ${
      isCompleted
        ? "bg-amber-50/70 border-amber-200/50 hover:border-amber-300 hover:shadow-md hover:-translate-y-1"
  ...
  return (
    <div className={baseClasses}>
      ...
      {isCompleted && (
        <div className="absolute left-0 top-4 bottom-4 w-1 bg-[#D4A85C] rounded-r-full opacity-80"></div>
      )}
      ...
      <div className="flex justify-between items-start mb-2 pl-2">
        ...
        <div className="shrink-0 text-gray-300 group-hover:text-gray-400 transition-colors flex gap-1 items-center">
          ...
          {isCompleted && <CheckCircle2 size={14} className="text-[#D4A85C]" />}
      ...
      <div
        className={`relative mt-2 p-2 rounded-lg text-[10px] leading-relaxed flex gap-2 ${
          isCompleted ? "bg-amber-100/50 pl-0" : "bg-gray-50"
        }`}
      >
        <Quote
          size={10}
          className={`shrink-0 mt-0.5 ${
            isCompleted ? "text-[#D4A85C]/50" : "text-gray-400"
          }`}
        />
        <p
          className={`italic ${
...
export const TransferBubble = ({ msg, isMe, onInteract }) => {
  ...
  const btnTextColor = "text-[var(--skin-transfer-active,#ff9f43)]";
